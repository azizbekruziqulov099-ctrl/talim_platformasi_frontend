...
export default function KindergartenWorkspace({
  ...
  return (
    <div className="kg-shell">
      ...
      {(!assignedOnly || canCreateInstitution) && <div className="kg-start-actions">
      ...
      {assignedOnly && workspaces.length === 0 && (
        <InfoNotice>
          <b>Bog‘cha ish joyi ulanmagan</b>
          <p>Yangi bog‘chani faqat Administrator markazi ochadi. Rahbar sizga xodim taklifini yuborgach, ish maydoni shu yerda avtomatik ko‘rinadi.</p>
        </InfoNotice>
      )}
