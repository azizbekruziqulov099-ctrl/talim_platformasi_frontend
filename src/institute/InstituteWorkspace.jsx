  ...
  if (selectedFaculty && selectedDepartment) return <div className="space-y-4">
    ...
    <Card className="p-5">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        {(selectedDepartment.yonalishlar || []).map(y => <div key={y.id} className="rounded-2xl border p-4 transition hover:-translate-y-0.5 hover:shadow-md" style={{ borderColor: COLORS.line, background: "#fff" }}>
          <div className="flex items-start justify-between gap-3">
            <button type="button" onClick={() => setSelectedProgram({ ...y, kafedra_nomi: selectedDepartment.nomi, kafedra_id: selectedDepartment.id })} className="min-w-0 flex-1 text-left">
              <div className="font-black" style={{ color: COLORS.blue }}>{y.nomi}</div>
