...
function FileImport({ apiBase, token, universityId, facultyId, type, templateHref, onCommitted, departments = [] }) {
  ...
  return <Card className="p-5">
    ...
    {s && <div className="mt-5 space-y-4">
      ...
      {type === "qabul" && matchingItems.length > 0 && <div className="space-y-3"><div><h4 className="font-black" style={{ color: COLORS.ink }}>Kafedralarni avtomatik tayyorlash</h4><p className="text-xs" style={{ color: COLORS.muted }}>Excelning “Yo‘nalish” ustuni kafedra nomi sifatida olinadi. Mavjud bo‘lsa bog‘lanadi, bo‘lmasa import paytida yaratiladi.</p></div>{matchingItems.map(([name, item]) => {
