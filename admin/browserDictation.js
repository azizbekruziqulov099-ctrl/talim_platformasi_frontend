...
// Chrome/Edge Web Speech has no Uzbek (uz-UZ) model: it either errors with
// language-not-supported or silently returns nothing. For Uzbek (and auto)
// an available Groq engine is therefore the automatic choice; Russian and
